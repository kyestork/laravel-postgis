...
abstract class SpatiallyRelatesToOneOrMany extends SpatialRelation
{
    /*
        3DDFullyWithin
        3DDWithin
        ...
        Within
    */
    public $spatialComparison = 'contains';
    ...
    public function __construct(Builder $query, Model $parent, $foreignGeometry = 'geometry', $localGeometry = 'geometry', $spatialComparison = null)
    {
        ...
        $this->foreignGeometry = $foreignGeometry;
        if($spatialComparison && in_array(Str::studly($spatialComparison), static::$allowedComparisons))
            $this->spatialComparison = $spatialComparison;
     ...
     * @return string
     */
    public function getForeignGeometry()
    {
        return $this->foreignGeometry;
    }
